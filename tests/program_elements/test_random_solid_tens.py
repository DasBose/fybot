...
def test_on_uses_default_max_duration() -> None:
    ...
    level_handler.set_id.assert_called_once_with(55, 30, "random_solid_tens")
...
def test_on_uses_explicit_duration_and_custom_range() -> None:
    ...
    level_handler.set_id.assert_called_once_with(25, 120, "random_solid_tens")
...
def test_on_applies_to_all_handlers() -> None:
    ...
    handler_a.set_id.assert_called_once_with(10, 5, "random_solid_tens")
    handler_b.set_id.assert_called_once_with(20, 5, "random_solid_tens")
...
def test_off_unsets_all_handlers() -> None:
    ...
    handler_a.unset.assert_called_once_with("random_solid_tens")
    handler_b.unset.assert_called_once_with("random_solid_tens")
